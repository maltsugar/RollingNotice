#
#  Be sure to run `pod spec lint RollingNotice.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.social_media_url   = "http://twitter.com/zgy"
  ...
  s.source       = { :git => "https://github.com/maltsugar/RollingNotice.git", :tag => "1.0.3" }
